...
![](image/image_SuJuXZLoRc.png)

然后多几个头：

![](image/image_mgdnFIxdTl.png)
...
![](image/微信图片_20240411215731_udDTG24ylb.jpg)

在上面那种形式中，就不是用concat，而是公式中的相加。

#### Deformable Attention

![](image/image_VueMq4VrWU.png)
